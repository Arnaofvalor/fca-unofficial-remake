...
```bash
npm install fca-unofficial-remake
```
It will download ` fca-unofficial-remake` from NPM repositories
...
## Example Usage
```javascript
const login = require("fca-unofficial-remake");
